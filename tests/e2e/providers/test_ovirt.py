...
class TestOVirtProvider:
    ...
    def test_create_ovirt_provider_skip_verify(self, test_namespace, provider_credentials):
    ...
    def test_create_ovirt_provider_with_cacert(self, test_namespace, provider_credentials):

...
class TestInventory:
    ...
    def test_get_inventory_hosts(self, test_namespace):
        ...
        pytest.skip("Inventory tests require configured providers with accessible inventory")
...
class TestInventoryIntegration:
    ...
    def test_inventory_with_vsphere_provider(self, test_namespace, provider_credentials):
        """Test inventory commands with a vSphere provider."""
        pytest.skip("Integration test - requires real vSphere environment")
    
    def test_inventory_with_openstack_provider(self, test_namespace, provider_credentials):

...
class TestOVirtProviderPatch:
    ...
    def test_patch_ovirt_provider_password(self, test_namespace, ovirt_provider, provider_credentials):
        ...
        get_result = test_namespace.run_mtv_command(f"get provider {ovirt_provider} -o yaml")
    ...
    def test_patch_ovirt_provider_username(self, test_namespace, ovirt_provider, provider_credentials):
    ...
    def test_patch_ovirt_provider_insecure_skip_tls(self, test_namespace, ovirt_provider):
    ...
    def test_patch_ovirt_provider_cacert(self, test_namespace, ovirt_provider, provider_credentials):
    ...
    def test_patch_ovirt_provider_multiple_fields(self, test_namespace, ovirt_provider, provider_credentials):

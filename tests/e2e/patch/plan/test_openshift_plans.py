...
class TestOpenShiftPlanPatch:
    ...
    def test_patch_plan_target_namespace(self, test_namespace, migration_plan):
        ...
        patch_cmd = (
            f"patch plan {migration_plan} --target-namespace '{target_namespace}'"
        )
    ...
    def test_patch_plan_target_node_selector(self, test_namespace, migration_plan):
        ...
        patch_cmd = (
            f"patch plan {migration_plan} --target-node-selector '{node_selector}'"
        )
    ...
    def test_patch_plan_error_invalid_legacy_drivers(
        self, test_namespace, migration_plan
    ):

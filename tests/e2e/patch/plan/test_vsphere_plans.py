...
class TestVSpherePlanPatch:
    ...
    def test_patch_plan_install_legacy_drivers_true(
    ...
    def test_patch_plan_install_legacy_drivers_false(
        self, test_namespace, migration_plan
    ):
    ...
    def test_patch_plan_preserve_cluster_cpu_model(
        ...
        if (
            "preserveClusterCPUModel:" in get_result.stdout
            or "preserveClusterCpuModel:" in get_result.stdout
        ):
            assert (
                "preserveClusterCpuModel: true" in get_result.stdout
                or "preserveClusterCPUModel: true" in get_result.stdout
            )
    ...
    def test_patch_plan_delete_guest_conversion_pod(
        self, test_namespace, migration_plan
    ):
    ...
    def test_patch_plan_pvc_name_template_use_generate_name(
        self, test_namespace, migration_plan
    ):
    ...
    def test_patch_plan_target_labels_and_selectors(
        self, test_namespace, migration_plan
    ):

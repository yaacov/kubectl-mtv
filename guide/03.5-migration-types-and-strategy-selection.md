...
1. **Conversion Migration**: Learn about external storage vendor integration in [Chapter 3.6: Conversion Migration](03.6-conversion-migration.md)
2. **Installation Setup**: Ensure proper kubectl-mtv installation in [Chapter 2: Installation and Prerequisites](02-installation-and-prerequisites.md)
3. **Quick Start**: Try your first migration in [Chapter 3: Quick Start - First Migration Workflow](03-quick-start-first-migration-workflow.md)
4. **Provider Setup**: Configure source platforms in [Chapter 4: Provider Management](04-provider-management.md)
5. **Advanced Planning**: Explore detailed migration planning in [Chapter 10: Migration Plan Creation](10-migration-plan-creation.md)

---

*Previous: [Chapter 3: Quick Start - First Migration Workflow](03-quick-start-first-migration-workflow.md)*  
*Next: [Chapter 3.6: Conversion Migration](03.6-conversion-migration.md)*

This technical guide aims to provide a comprehensive reference for using `kubectl-mtv`, the command-line interface for managing virtual machine migrations using Forklift/Migration Toolkit for Virtualization (MTV).

The following is a Table of Contents organized from introduction and setup through core management functions and advanced features, with a strong emphasis on detailed configuration and practical examples ("how-tos").

***

## Table of Contents: Complete Technical Guide for kubectl-mtv
...
3.5 **[Migration Types and Strategy Selection](03.5-migration-types-and-strategy-selection.md)**
...
3.6 **[Conversion Migration](03.6-conversion-migration.md)**
...
4.  **[Provider Management](04-provider-management.md)**
...
5.  **[Migration Host Management (vSphere Specific)](05-migration-host-management.md)**
...
6.  **[VDDK Image Creation and Configuration](06-vddk-image-creation-and-configuration.md)**
...
7.  **[Inventory Management](07-inventory-management.md)**
...
8.  **[Query Language Reference and Advanced Filtering](08-query-language-reference-and-advanced-filtering.md)**
...
9.  **[Mapping Management](09-mapping-management.md)**
...
9.5 **[Storage Array Offloading and Optimization](09.5-storage-array-offloading-and-optimization.md)**
...
10. **[Migration Plan Creation](10-migration-plan-creation.md)**
...
11. **[Customizing Individual VMs (The PlanVMS Format)](11-customizing-individual-vms-planvms-format.md)**
...
12. **[Target VM Placement (Operational Lifetime)](12-target-vm-placement.md)**
...
13. **[Migration Process Optimization (Convertor Pod Scheduling)](13-migration-process-optimization.md)**
...
14. **[Migration Hooks](14-migration-hooks.md)**
...
15. **[Advanced Plan Patching](15-advanced-plan-patching.md)**
...
16. **[Plan Lifecycle Execution](16-plan-lifecycle-execution.md)**
...
17. **[Debugging and Troubleshooting](17-debugging-and-troubleshooting.md)**
...
18. **[Best Practices and Security](18-best-practices-and-security.md)**
...
19. **[Model Context Protocol (MCP) Server Integration](19-model-context-protocol-mcp-server-integration.md)**
...
20. **[Integration with KubeVirt Tools](20-integration-with-kubevirt-tools.md)**
...
21. **[Command Reference](21-command-reference.md)**

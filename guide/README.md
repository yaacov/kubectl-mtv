...
1.  **[Overview of kubectl-mtv](01-overview-of-kubectl-mtv)**
...
2.  **[Installation and Prerequisites](02-installation-and-prerequisites)**
...
3.  **[Quick Start: First Migration Workflow](03-quick-start-first-migration-workflow)**
...
4.  **[Migration Types and Strategy Selection](03.5-migration-types-and-strategy-selection)**
...
5.  **[Conversion Migration](03.6-conversion-migration)**
...
6.  **[Provider Management](04-provider-management)**
...
7.  **[Migration Host Management (vSphere Specific)](05-migration-host-management)**
...
8.  **[VDDK Image Creation and Configuration](06-vddk-image-creation-and-configuration)**
...
9.  **[Inventory Management](07-inventory-management)**
...
10. **[Query Language Reference and Advanced Filtering](08-query-language-reference-and-advanced-filtering)**
...
11. **[Mapping Management](09-mapping-management)**
...
12. **[Storage Array Offloading and Optimization](09.5-storage-array-offloading-and-optimization)**
...
13. **[Migration Plan Creation](10-migration-plan-creation)**
...
14. **[Customizing Individual VMs (The PlanVMS Format)](11-customizing-individual-vms-planvms-format)**
...
15. **[Target VM Placement (Operational Lifetime)](12-target-vm-placement)**
...
16. **[Migration Process Optimization (Convertor Pod Scheduling)](13-migration-process-optimization)**
...
17. **[Migration Hooks](14-migration-hooks)**
...
18. **[Advanced Plan Patching](15-advanced-plan-patching)**
...
19. **[Plan Lifecycle Execution](16-plan-lifecycle-execution)**
...
20. **[Debugging and Troubleshooting](17-debugging-and-troubleshooting)**
...
21. **[Best Practices and Security](18-best-practices-and-security)**
...
22. **[Model Context Protocol (MCP) Server Integration](19-model-context-protocol-mcp-server-integration)**
...
23. **[Integration with KubeVirt Tools](20-integration-with-kubevirt-tools)**
...
24. **[Command Reference](21-command-reference)**

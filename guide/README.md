...
4.  **[Migration Types and Strategy Selection](/guide/03.5-migration-types-and-strategy-selection)**
...
5.  **[Conversion Migration](/guide/03.6-conversion-migration)**
...
6.  **[Provider Management](/guide/04-provider-management)**
...
7.  **[Migration Host Management (vSphere Specific)](/guide/05-migration-host-management)**
...
8.  **[VDDK Image Creation and Configuration](/guide/06-vddk-image-creation-and-configuration)**
...
9.  **[Inventory Management](/guide/07-inventory-management)**
...
10. **[Query Language Reference and Advanced Filtering](/guide/08-query-language-reference-and-advanced-filtering)**
...
11. **[Mapping Management](/guide/09-mapping-management)**
...
12. **[Storage Array Offloading and Optimization](/guide/09.5-storage-array-offloading-and-optimization)**
...
13. **[Migration Plan Creation](/guide/10-migration-plan-creation)**
...
14. **[Customizing Individual VMs (The PlanVMS Format)](/guide/11-customizing-individual-vms-planvms-format)**
...
15. **[Target VM Placement (Operational Lifetime)](/guide/12-target-vm-placement)**
...
16. **[Migration Process Optimization (Convertor Pod Scheduling)](/guide/13-migration-process-optimization)**
...
17. **[Migration Hooks](/guide/14-migration-hooks)**
...
18. **[Advanced Plan Patching](/guide/15-advanced-plan-patching)**
...
19. **[Plan Lifecycle Execution](/guide/16-plan-lifecycle-execution)**
...
20. **[Debugging and Troubleshooting](/guide/17-debugging-and-troubleshooting)**
...
21. **[Best Practices and Security](/guide/18-best-practices-and-security)**
...
22. **[Model Context Protocol (MCP) Server Integration](/guide/19-model-context-protocol-mcp-server-integration)**
...
23. **[Integration with KubeVirt Tools](/guide/20-integration-with-kubevirt-tools)**
...
24. **[Command Reference](/guide/21-command-reference)**

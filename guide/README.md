...
2.  **[Installation and Prerequisites](guide/02-installation-and-prerequisites)**
...
3.  **[Quick Start: First Migration Workflow](guide/03-quick-start-first-migration-workflow)**
...
4.  **[Migration Types and Strategy Selection](guide/04-migration-types-and-strategy-selection)**
...
5.  **[Conversion Migration](guide/05-conversion-migration)**
...
6.  **[Provider Management](guide/06-provider-management)**
...
7.  **[Migration Host Management (vSphere Specific)](guide/07-migration-host-management)**
...
8.  **[VDDK Image Creation and Configuration](guide/08-vddk-image-creation-and-configuration)**
...
9.  **[Inventory Management](guide/09-inventory-management)**
...
10. **[Query Language Reference and Advanced Filtering](guide/10-query-language-reference-and-advanced-filtering)**
...
11. **[Mapping Management](guide/11-mapping-management)**
...
12. **[Storage Array Offloading and Optimization](guide/12-storage-array-offloading-and-optimization)**
...
13. **[Migration Plan Creation](guide/13-migration-plan-creation)**
...
14. **[Customizing Individual VMs (The PlanVMS Format)](guide/14-customizing-individual-vms-planvms-format)**
...
15. **[Target VM Placement (Operational Lifetime)](guide/15-target-vm-placement)**
...
16. **[Migration Process Optimization (Convertor Pod Scheduling)](guide/16-migration-process-optimization)**
...
17. **[Migration Hooks](guide/17-migration-hooks)**
...
18. **[Advanced Plan Patching](guide/18-advanced-plan-patching)**
...
19. **[Plan Lifecycle Execution](guide/19-plan-lifecycle-execution)**
...
20. **[Debugging and Troubleshooting](guide/20-debugging-and-troubleshooting)**
...
21. **[Best Practices and Security](guide/21-best-practices-and-security)**
...
24. **[System Health Checks](guide/24-system-health-checks)**
...
25. **[Settings Management](guide/25-settings-management)**
...
27. **[TSL - Tree Search Language Reference](guide/27-tsl-tree-search-language-reference)**
...
28. **[KARL - Kubernetes Affinity Rule Language Reference](guide/28-karl-kubernetes-affinity-rule-language-reference)**

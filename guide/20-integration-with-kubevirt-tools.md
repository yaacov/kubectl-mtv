...
*Previous: [Chapter 19: Model Context Protocol (MCP) Server Integration](/guide/19-model-context-protocol-mcp-server-integration)*  
*Next: [Chapter 21: Command Reference](/guide/21-command-reference)*
